...
public class PlayerController : MonoBehaviour
{
    ...
    public Rigidbody2D rb; //private a public
    public bool isGroundedBool = false; // private a public
    public bool canDoubleJump = false;// private a public
    ...
    public float moveX; //private a public
    ...
    public void Update()
    {
        ...
        //{
           ...
           // {
                ...
                //moveX = Input.GetAxis("Horizontal"); // comente esto para que funcione el fixed update
            //}
...
*/
    ...
    public void SetAnimations()
    {
        ...
        //playeranim.SetBool("isGroundedBool", isGroundedBool); // mostraba un mensaje, lo saque
...
public void FixedUpdate()
{
    ...
    //moveX = 1.0f;  // fuerzo valor para probar sin input
    rb.velocity = new Vector2(moveX * moveSpeed, rb.velocity.y);

    //Debug.Log("Velocity del Rigidbody2D: " + rb.velocity);
}


    /*
    public void FixedUpdate() // private a public
    {
        // Player movement
       // if (controlmode == Controls.pc)
       // {
    ...
    */
    ...
    public void Jump(float jumpForce) // cambie private por public
    {
        rb.velocity = new Vector2(rb.velocity.x, 0); // Zero out vertical velocity
        rb.AddForce(Vector2.up * jumpForce, ForceMode2D.Impulse);
        Debug.Log($"velocidad del saltito: {rb.velocity.y}");
...
public float horizontalInput // para probar si podia hacer un get set
{
    get { return moveX; }
    set { moveX = value; }
}
